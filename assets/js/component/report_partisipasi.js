const REPORT_PENERIMAAN_PARTISIPASI = {
	data : function() {
		return {
            userdata : [],
            forms : {
	...
	created : function(){
		const v = this;
		store.commit("changeNavTitle", "Report Penerimaan Partisipasi"); // JUDUL PAGE
	},
	mounted : function(){
		var v = this;
		v.get_session();
	...
	methods : {
        ...
        handleData : function(data_state){
            ...
            if(data_state == "SHOW"){
                ...
                $.ajax({
                    type : "GET",
                    url : BASE_URL+"report/report_partisipasi",
                    data : v.forms,
                ...
                <table class="table table-bordered table-striped table-hover datatable">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in partList">
                            ...
                            <td>{{ item.provinsi }}</td>
                            <td>{{ item.kab_kota }}</td>
                            <td class="text-right">{{ $root.formatNumber(item.dana_partisipasi) }}</td>
