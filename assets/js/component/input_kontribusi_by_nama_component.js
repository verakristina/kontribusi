const INPUT_KONTRIBUSI_BY_NAMA = {
	data : function() {
		return {
            userdata : [],
            forms : {
	...
	created : function(){
        const v = this;
		store.commit("changeNavTitle", "Input Kontribusi Berdasarkan Nama");
	},
	mounted : function(){
		var v = this;
        v.get_session();
	...
	methods : {
        ...
        save_form : function(){
            ...
            $.ajax({
                type : "POST",
                url : BASE_URL+"api/save_kontribusi_by_name_dev",
                data : f_data,
		...
		<div class="card">
			<div class="card-header card-header-icon card-header-warning">
				...
				<div class="card-title">
					Input Kontribusi Berdasarkan Nama
				</div>
			</div>
            <div class="card-body">
                <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover" :style='{"width" : "1800px", "font-size" : "12px"}'>
                    <thead>
                        <tr>
