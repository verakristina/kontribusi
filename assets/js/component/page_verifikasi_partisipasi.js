const PAGE_VERIF_PARTISIPASI = {
	...
	created : function(){
		const v = this;
        store.commit("changeNavTitle", "Verifikasi Dana Partisipasi"); // JUDUL PAGE
	...
	methods : {
        ...
        getVerifikasiList : function(){
            ...
            $.ajax({
                type: "GET",
                url : BASE_URL+"api/get_verif_partisipasi_list",
                data : {
                    bulan : v.forms.bulan,
                    tahun : v.forms.tahun
                },
                    ...
                    <tbody>
                        <tr v-for="(item, index) in dataList.verification_list">
                            ...
                            <td class="text-center">
                                <router-link class="btn btn-success btn-sm" :to="{ path: '/verify-partisipasi/'+item.id+'?month='+forms.bulan+'&year='+forms.tahun }">
